...
- **測試執行結果**: 161 個測試全部通過
- **詳細覆蓋率數據**:
  - 指令覆蓋率: 17% (30,699 of 37,193)
  - 分支覆蓋率: 9% (4,345 of 4,804)
  - 行覆蓋率: 約 22% (1,384 of 6,179)
  - 方法覆蓋率: 約 19% (404 of 2,129)
  - 類別覆蓋率: 約 40% (81 of 202)

## 高優先級待測試類別 (前5名)

### 1. TokenHelper
- **類別路徑**: `cn.omisheep.authz.core.tk.TokenHelper`
- **當前實際覆蓋率**: 31% (根據 JaCoCo 報告，tk 套件整體覆蓋率)
- **測試狀態**: 部分覆蓋
- **核心邏輯簡述**: 
  - JWT token 生成、解析、驗證
